...
Мозаика здесь: цветовая 4x3 мозаика из WRO RoboMission Senior 2026.
...
настройки, распознавание выполняется на ESP32. Целевая мозаика: WRO
RoboMission Senior 2026.
...
маркеры и ручная модель по четырем углам не используются. Это основной режим
для чтения мозаики WRO RoboMission Senior 2026.
